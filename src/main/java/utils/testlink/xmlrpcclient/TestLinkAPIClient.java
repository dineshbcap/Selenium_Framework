package utils.testlink.xmlrpcclient;
...
public class TestLinkAPIClient implements TestLinkAPIConst {
	...
	public TestLinkAPIResults reportTestCaseResult(String projectName, String testPlanName, String testSuiteID, String testCaseNameOrVisibleID, String execNotes, String testResultStatus,String testBuildName) throws TestLinkAPIException {
		...
		if(testBuildName != null) {
			...
			if(buildID == null) {
				throw new TestLinkAPIException("The build name " + testBuildName + " was not found in test plan " + testPlanName
						+ " and the test result for test case " + testCaseNameOrVisibleID + " could not be recorded.");
			}
		}
	...
	public TestLinkAPIResults reportTestCaseResult(String projectName, String testPlanName, String testCaseNameOrVisibleID, Integer buildID, String execNotes, String testResultStatus) throws TestLinkAPIException {
		...
		if(buildID == null) {
			throw new TestLinkAPIException("The build Id " + buildID + " was not found in test plan " + testPlanName
					+ " and the test result for test case " + testCaseNameOrVisibleID + " could not be recorded.");
		}
	...
	public Integer createTestSuite(String projectName, String suiteName, String description) throws TestLinkAPIException {
		...
		if(projectID != null) {
			...
			throw new TestLinkAPIException("The project " + projectName + " was not found and the test suite " + suiteName
	...
	public Integer createTestCase(String authorLoginName, String projectName, String suiteName, String testCaseName, String summary, String steps, String expectedResults, String importance) throws TestLinkAPIException {
		...
		return createTestCase(authorLoginName, projectID, suiteID, testCaseName, summary, steps, expectedResults, null, null, null, null,
				null, importance);
	}

	/**
	 * Create a new test case using all the variables that are provided by the TestLink API. For more information on the
	 * parameters refer to the TestLink API documentation.
	 * 
	 * @param projectID
	 *            Required
	 * @param suiteID
	...
	/**
	 * Appends that latest version of a test case to a test plan with a default level of urgency. Can only handle test cases
	 * associated with first level suites.
	 * 
	 * 
	 * @param projectName
	 *            Required
	...
	/**
	 * Appends that latest version of a test case to a test plan with a medium urgency. Can only handle test in first level
	 * suites.
	 * 
	 * @param projectName
	 *            Required
	...
	public TestLinkAPIResults addTestCaseToTestPlan(String projectName, String planName, String testCaseName, Integer execOrder, String urgency) throws TestLinkAPIException {
		Integer projectID = TestLinkAPIHelper.getProjectID(this, projectName);
		if(projectID == null) {
			throw new TestLinkAPIException("The project " + projectName + " was not found and the test case " + testCaseName
		...
		if(caseInfo == null) {
			throw new TestLinkAPIException("The test case identifier " + caseID + " was not found and the test case " + testCaseName
					+ " could not be appended to test plan " + planName + ".");
		}
		Map<String, Object> projectInfo = TestLinkAPIHelper.getProjectInfo(this, projectName);
		if(projectInfo == null) {
			throw new TestLinkAPIException("The project information for " + projectName + " was not found and the test case "
		...
		TestLinkAPIResults results = addTestCaseToTestPlan(projectID, planID, caseID, visibleTestCaseID, new Integer(version.toString()),
				execOrder, urgency);
		return results;
	}
